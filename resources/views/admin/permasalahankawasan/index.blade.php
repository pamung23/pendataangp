...
@section('title', 'Permasalahan Kawasan')
...
<div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        ...
        <form action="{{ route('permasalahankawasan.index') }}" method="GET" id="triwulan-form" class="mb-4 ml-auto">
