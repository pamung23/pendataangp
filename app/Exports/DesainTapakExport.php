...
class DesainTapakExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        $data = DesainTapak::whereYear('created_at', $this->selectedYear)->get();
    ...
    {
        return [
            ['Tabel: Desain Tapak Pemanfaatan Jasa Lingkungan Hidup'],
            ...
            [
                ...
                'Desain Tapak', // Kolom Desain Tapak (Kosong)
                '',
                '',
                'Keterangan',
            ],
            [
                ...
                '', // Kolom Luas Zona/Blok Pemanfaatan (Ha) (Kosong)
                '', // Sub-heading Desain Tapak
                'Ruang Publik (Ha)', // Kolom Ruang Publik (Ha) (Kosong)
                'Ruang Usaha (Ha)', // Kolom Ruang Usaha (Ha) (Kosong)
