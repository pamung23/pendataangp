...
class DaerahPenyanggaExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        $data = DaerahPenyangga::whereYear('created_at', $this->selectedYear)->get();
    ...
    {
        return [
            ['Tabel: Daerah Penyangga Kawasan Konservasi'],
